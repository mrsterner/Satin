...
/**
 * Mojank working in divergent branches for half a century, {@link ShaderProgram}
 * is a copy of an old implementation of {@link JsonEffectShaderProgram}.
 * The latter has since been updated to have the {@link JsonEffectShaderProgram#bindSampler(String, IntSupplier)}
 * while the former still uses {@link ShaderProgram#addSampler(String, Object)}.
 *
